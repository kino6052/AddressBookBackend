...
(function(){
  ...
  app.projectDao = brite.registerDao(new brite.InMemoryDaoHandler("Project",seedProjects));
  
  app.taskDao = brite.registerDao(new brite.InMemoryDaoHandler("Task",seedTasks));	
