...
(function() {
	...
	brite.registerView("ProjectView",{
		...
		create: function(data){
			...
			// otherwise, we fetch it and return the appropriate promise.
				...
				return app.projectDao.get(data.projectId).pipe(function(project){
	...
	function refreshTable(){
        ...
        return app.groupsDao.get({}).done(function(groupList){
           var taskTableHtml = render("tmpl-ProjectView-taskList", {tasks:groupList});
